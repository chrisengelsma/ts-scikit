...
export class EigenSolver {
   ...
   * @private
   */
  private static _SolveSymmetric3x3Hybrid(a: number[][], v: number[][], d: number[]): void {
   ...
   * @private
   */
  private static _SortDescending3x3(v: number[][], d: number[]): void {
    for (let i = 0; i < 3; ++i) {
   ...
   * @private
   */
  private static _GetEigenvaluesSymmetric3x3(a: number[][], d: number[]): void {
    const a00 = a[0][0],
      a01 = a[0][1], a11 = a[1][1],
      a02 = a[0][2], a12 = a[1][2], a22 = a[2][2];
    const de = a01 * a12;
   ...
   * @private
   */
  private static _SolveSymmetric3x3QL(a: number[][], v: number[][], d: number[]): void {
    // Reduce A to a tri-diagonal form.
    const e: number[] = new Array<number>(3);
